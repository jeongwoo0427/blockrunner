...
const List<Level> kLevels = [
  Level(number: 1, minMoves: 5, demo: TutorialDemo.slide),
  Level(number: 2, minMoves: 6),
  Level(number: 3, minMoves: 3, demo: TutorialDemo.blockBrake),
  Level(number: 4, minMoves: 5, demo: TutorialDemo.edgeWall),
  Level(number: 5, minMoves: 9),
  Level(number: 6, minMoves: 3),
  Level(number: 7, minMoves: 6),
  Level(number: 8, minMoves: 14),
  Level(number: 9, minMoves: 15),
  Level(number: 10, minMoves: 9),
  Level(number: 11, minMoves: 9),
  Level(number: 12, minMoves: 21),
  Level(number: 13, minMoves: 5, demo: TutorialDemo.blackHole),
  Level(number: 14, minMoves: 14),
  Level(number: 15, minMoves: 17),
  Level(number: 16, minMoves: 20),
  Level(number: 17, minMoves: 12),
];
