...
const List<Level> kLevels = [
  ...
  Level(number: 5, minMoves: 4, demo: TutorialDemo.edgeWall),
  Level(number: 6, minMoves: 4),
  Level(number: 7, minMoves: 4),
  Level(number: 8, minMoves: 5),
  Level(number: 9, minMoves: 5),
  Level(number: 10, minMoves: 6),
  Level(number: 11, minMoves: 5),
  Level(number: 12, minMoves: 6),
  Level(number: 13, minMoves: 8),
  Level(number: 14, minMoves: 6),
  Level(number: 15, minMoves: 7),
  Level(number: 16, minMoves: 9),
  Level(number: 17, minMoves: 7),
  Level(number: 18, minMoves: 5, demo: TutorialDemo.blackHole),
  Level(number: 19, minMoves: 9),
  Level(number: 20, minMoves: 7),
  Level(number: 21, minMoves: 7),
  Level(number: 22, minMoves: 8),
  Level(number: 23, minMoves: 8),
  Level(number: 24, minMoves: 9),
  Level(number: 25, minMoves: 9),
];
