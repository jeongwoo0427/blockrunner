...
const List<Level> kLevels = [
  ...
  Level(number: 10, minMoves: 5),
  Level(number: 11, minMoves: 6),
  Level(number: 12, minMoves: 6),
  Level(number: 13, minMoves: 7),
  Level(number: 14, minMoves: 7),
  Level(number: 15, minMoves: 5, demo: TutorialDemo.blackHole),
