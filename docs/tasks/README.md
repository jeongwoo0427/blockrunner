...
| 11 | [11-i18n.md](11-i18n.md) | **다국어** (ko·en·ja·zh·fr) | 대기 | 00, 08 |
...
**11(다국어)은 10(반응형) 뒤가 자연스럽다.** 번역문은 한국어보다 길어지는 경우가 많아 레이아웃이 먼저 다져져 있는 편이 낫다. 다만 `10` 에 남은 것이 검증 성격이라 강제하지는 않는다.
